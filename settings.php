...
function wp_nasaads_query_importer_options_display_token_field() {
    ...
    Token: <input name="wp_nasaads_query_importer-token" id="wp_nasaads_query_importer-token_field" type="text" value="<?php echo esc_attr(get_option('wp_nasaads_query_importer-token')); ?>" size="40"/>
...
function wp_nasaads_query_importer_options_display_template_field() {
    ...
    <textarea id="wp_nasaads_query_importer-template_field" name="wp_nasaads_query_importer-template" style="width: 100%" rows="4"><?php echo esc_attr(get_option('wp_nasaads_query_importer-template')); ?></textarea></p>
    ...
    <p style="max-width: 460px">The following placeholders are defined and will be replaced by the corresponding field record:<br /><?php echo esc_attr(implode(', ', array_map(function($s) { return '%'.$s; }, array_keys(wp_nasaads_query_importer_record_mapping())))); ?></p>
    <?php
}
...
function wp_nasaads_query_importer_options_display_numrecords_field() {
    ...
    <input name="wp_nasaads_query_importer-numrecords" id="wp_nasaads_query_importer-numrecords_field" type="radio" value="0"<?php if (esc_attr(get_option('wp_nasaads_query_importer-numrecords')) == 0) { echo " checked"; } ?> /> Never<br />
    <input name="wp_nasaads_query_importer-numrecords" id="wp_nasaads_query_importer-numrecords_field" type="radio" value="1"<?php if (esc_attr(get_option('wp_nasaads_query_importer-numrecords')) == 1) { echo " checked"; } ?> /> Always<br />
    <input name="wp_nasaads_query_importer-numrecords" id="wp_nasaads_query_importer-numrecords_field" type="radio" value="2"<?php if (esc_attr(get_option('wp_nasaads_query_importer-numrecords')) == 2) { echo " checked"; } ?> /> Depends, i.e., only if more records are found than listed
    <?php
}
